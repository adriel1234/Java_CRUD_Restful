package com.adriel.projeto04.adriel_projeto04.view.controller;
...
import com.adriel.projeto04.adriel_projeto04.services.ProdutoService;
import com.adriel.projeto04.adriel_projeto04.shared.ProdutoDTO;
import com.adriel.projeto04.adriel_projeto04.view.model.ProdutoRequest;
import com.adriel.projeto04.adriel_projeto04.view.model.ProdutoResponse;
...
public class ProdutoController {
    ...
    public ResponseEntity<List<ProdutoResponse>> obterTodos(){
        ...
        List<ProdutoDTO> produdos =  produtoService.obterTodos();
        ModelMapper mapper = new ModelMapper();

        List<ProdutoResponse> resposta = produdos.stream()
